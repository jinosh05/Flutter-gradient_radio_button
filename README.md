...
I kept the code as original as possible with proper Commented Guides for anyone to understand and implement. Still you need to follow these steps.
  ...
  - Now download this [Repo](https://github.com/jinosh05/gradient_radio_button/archive/refs/heads/master.zip)
  - Extract the Repo into your newly created **gradient_radio_button** and replace the required files.
